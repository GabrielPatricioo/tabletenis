    ...
    <div>
      <div className="w-full bg-violet-100 ">
        <img
          ...
          src="/imagens/banner-historia.jpg"
        ></img>
          ...
          <div className="text-left grid gap-10  lg:grid-cols-3">
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              <img
                ...
                src="/imagens/banner-objetivo.png"
              ></img>
            ...
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              <img
                className="rounded-sm h-96 w-full object-cover"
                src="/imagens/banner-equipamentos.png"
              ></img>
              <div className="p-5 text-justify">
                <div className="flex flex-row  mb-3  ">
                  ...
                  <h1 className="poppins-bold text-violet-100 ml-5 text-3xl ">Equipamentos</h1>
                </div>
            ...
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              <img
                className="rounded-sm h-96 w-full object-cover"
                src="/imagens/banner-duração.jpg"
              ></img>
              <div className="p-5 text-justify">
                <div className="flex flex-row  mb-3  ">
                  <svg
            ...
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              ...
              <div className="p-5 text-justify">
                <div className="flex flex-row  mb-3  ">
                  ...
                  <h1 className="poppins-bold text-violet-100 ml-5 text-3xl ">Saque</h1>
                </div>
            ...
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              ...
              <div className="p-5 text-justify">
                <div className="flex flex-row  mb-3  ">
                  ...
                  <h1 className="poppins-bold ml-5 text-violet-100 text-3xl ">Na partida</h1>
                </div>
            ...
            <div className="poppins-light h-auto   items-center grid-cols-2 text-violet-300 bg-gradient-to-tr from-violet-600 to-indigo-900 border-2 border border-violet-600   rounded-md  max-w-5xl ">
              <img
                className="rounded-sm h-96 w-full object-cover"
                src="/imagens/banner-regras3.png"
              ></img>
              <div className="p-5 text-justify">
                <div className="flex flex-row  mb-3  ">
                  <svg
